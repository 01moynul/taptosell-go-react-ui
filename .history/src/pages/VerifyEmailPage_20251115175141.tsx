...
function VerifyEmailPage() {
  // We expect the email to be passed in the URL, e.g., /verify-email?email=user@example.com
  ...
  // Update email state if URL parameter changes
  useEffect(() => {
  ...
  const handleVerify = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setMessage(response.data.message || 'Email verified successfully! Your account is now pending approval.');
