...
import { fetchCategories, fetchBrands, type TaxonomyItem } from '../services/taxonomyService'; // CORRECTED path
import { type SupplierProduct } from '../services/supplierProductService'; // CORRECTED path
import axios from 'axios';
import ProductForm from '../components/supplier/ProductForm'; // CORRECTED path
...
// --- Rendering Logic ---
    ...
    // 🚨 NEW CHECK: Prevent rendering ProductForm if we are in Edit Mode but the product is null (e.g., product not found or failed fetch)
    if (isEditMode && !product) return <h1 className="text-xl text-red-600">Product not found or unauthorized access.</h1>;
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <ProductForm 
                ...
                // Now, initialProduct can ONLY be SupplierProduct or undefined, never null.
