...
export const AIChatWindow: React.FC = () => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            // FIX: Define a minimal interface for the error instead of using 'any'.
            // This satisfies the linter by being explicit about what we expect.
            interface ApiError {
                response?: {
                    status: number;
                };
            ...
            // Cast the unknown 'err' to our specific 'ApiError' shape
